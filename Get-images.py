...
#creating the directory path to store the dataset
...
while True:
    ...
    frame = cv2.resize(frame, None, fx=0.99, fy=0.99, interpolation=cv2.INTER_AREA)
...
#    roi = cv2.resize(roi, (64, 64))
    ...
    ret, test_image = cv2.threshold(th3, min_value ,255, cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)
    time.sleep(5)
    cv2.imwrite("/fianal/Downloads/soe/im1.jpg", roi)
